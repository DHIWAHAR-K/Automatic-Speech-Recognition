...
def mel_filters(device, n_mels: int) -> torch.Tensor:
    ...
    ----------
    device: torch.device
        The device to load the mel filters onto.
...
def log_mel_spectrogram(
    ...
    """
    Compute the log-Mel spectrogram of the given audio.

    Parameters
    ----------
    audio: Union[str, np.ndarray, torch.Tensor]
        The path to the audio file or a NumPy array or Tensor containing the audio waveform.
